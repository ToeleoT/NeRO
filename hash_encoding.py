...
from utils import get_voxel_vertices, get_grid_vertices


class HashEmbedder_2d(nn.Module):
    def __init__(self, bounding_box, n_levels=16, n_features_per_level=2,\
                log2_hashmap_size=24, base_resolution=16, finest_resolution=524288):
    ...
    def forward(self, x):
        ...
        for i in range(self.n_levels):
            resolution = torch.floor(self.base_resolution * self.b**i).cuda()
            voxel_min_vertex, voxel_max_vertex, hashed_voxel_indices, keep_mask = get_grid_vertices(\
                                                x, self.bounding_box, \
...
class HashEmbedder(nn.Module):
    def __init__(self, bounding_box, n_levels=16, n_features_per_level=2,\
                log2_hashmap_size=19, base_resolution=16, finest_resolution=256):
